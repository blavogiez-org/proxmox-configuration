...
**OpenBao est autant puissant que complexe et pour une installation minimaliste, on pourrait s'en passer. On décide de l'utiliser surtout pour apprendre puisque Vault/OpenBao sont des standards**

OpenBao peut être exposé (***à accès VPN restreint par Caddy***) sur :
...
Il y a 4 objets importants dans OpenBao :
